import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,b as n,a as s,t as l,o as t}from"./app-D84nprG6.js";const d={};function u(o,a){return t(),i("div",null,[a[0]||(a[0]=n(`<h1 id="微信小程序" tabindex="-1"><a class="header-anchor" href="#微信小程序"><span>微信小程序</span></a></h1><h2 id="注册账号" tabindex="-1"><a class="header-anchor" href="#注册账号"><span>注册账号</span></a></h2><ul><li>注册微信小程序账号</li><li>拿到 appId</li><li>如果上线的话 要配置 访问的合法域名</li><li>备案过的 域名 不能使用 公网ip</li><li>https协议</li><li>上线 版本管理都在控制台里面</li></ul><h2 id="小程序的配置" tabindex="-1"><a class="header-anchor" href="#小程序的配置"><span>小程序的配置</span></a></h2><ul><li>app.json 全局配置文件</li><li>app.js 全局js文件</li><li>app.wxss 全局样式文件</li></ul><h2 id="app-json之pages" tabindex="-1"><a class="header-anchor" href="#app-json之pages"><span>app.json之pages</span></a></h2><p>pages:[] 添加一段路径 会自动在pages里面生成页面</p><ul><li>默认显示的页面为pages里面第一个路径页面</li><li>&quot;entryPagePath&quot;: &quot;pages/index/index&quot;, （设置入口文件）</li></ul><h2 id="app-json-之-tabbar" tabindex="-1"><a class="header-anchor" href="#app-json-之-tabbar"><span>app.json 之 tabBar</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>tabBar list必须 2-5
 &quot;tabBar&quot;: {
    &quot;color&quot;: &quot;#ff0000&quot;,
