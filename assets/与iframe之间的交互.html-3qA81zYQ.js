import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,b as e,o as i}from"./app-C3oFAs9P.js";const t="/docs/assets/img-DHDCHuiN.png",l="/docs/assets/img_1-9HAD3Zvr.png",p="/docs/assets/img_2-BPnPFjQb.png",c="/docs/assets/img_3-CGOciEoW.png",o="/docs/assets/img_4-Dtuu6YUB.png",d="/docs/assets/img_5-DQX89bqt.png",r="/docs/assets/img_6-CDe3gK4d.png",u={};function m(v,n){return i(),s("div",null,n[0]||(n[0]=[e('<p>使用背景，前端采用html单页面引用vue的方式</p><p><img src="'+t+'" alt="img.png" loading="lazy"> 页面大致是这样，现在需要做的是在iframe页面里面触发事件跳转页面，并且使父级vue页面的左侧菜单选中相应页面的菜单，当然iframe子页面也是vue，但是其他页面也不影响</p><h2 id="一、子页面向父页面传值" tabindex="-1"><a class="header-anchor" href="#一、子页面向父页面传值"><span>一、子页面向父页面传值</span></a></h2><p>1、在iframe页面里触发事件，找到他的父级页面的dom元素，用postMessage传值，里面所有的都是参数，cmd是为了能在父级vue页面区分该操作的用途</p><figure><img src="'+l+'" alt="img_1.png" tabindex="0" loading="lazy"><figcaption>img_1.png</figcaption></figure><p>2、在父级vue页面的周期函数mounted中监听iframe中发来的消息，传来的参数就在event.data里面。（loadHtmlFrag() 则是在父级vue页面methods中的方法）</p><figure><img src="'+p+'" alt="img_2.png" tabindex="0" loading="lazy"><figcaption>img_2.png</figcaption></figure><h2 id="二、父页面向子页面传值" tabindex="-1"><a class="header-anchor" href="#二、父页面向子页面传值"><span>二、父页面向子页面传值</span></a></h2><p>会了子页面向父业面传值，那父页面向子页面传值也就会了，就是吧一二步骤调换未知</p><p>1、在父页面中触发事件传递参数，在父页面通过ref来得到iframe子页面的dom元素，然手使用postMessage传参。</p><figure><img src="'+c+'" alt="img_3.png" tabindex="0" loading="lazy"><figcaption>img_3.png</figcaption></figure><p><code>通过ref获取dom，父页面的iframe标签里写ref就行</code></p><p><img src="'+o+'" alt="img_4.png" loading="lazy"> 2、和上面一样，在子页面的周期函数mounted中监听父页面发来的消息</p><p><img src="'+d+'" alt="img_5.png" loading="lazy"><img src="'+r+`" alt="img_6.png" loading="lazy"></p><h2 id="补充" tabindex="-1"><a class="header-anchor" href="#补充"><span>补充</span></a></h2><p>为了确保ifame可以在加载完成后触发父给子的函数, 应在子内在给父发送,在父接受参数中触发</p><h3 id="父" tabindex="-1"><a class="header-anchor" href="#父"><span>父</span></a></h3><h4 id="接收" tabindex="-1"><a class="header-anchor" href="#接收"><span>接收</span></a></h4><div class="language-vue line-numbers-mode" data-ext="vue" data-title="vue"><pre class="language-vue"><code>mounted() {
